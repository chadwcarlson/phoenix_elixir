defmodule PhoenixElixir.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PhoenixElixir.MyChannel do
        use PhoenixElixir.Web, :channel
        alias PhoenixElixir.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :phoenix_elixir,
                        pubsub_server: PhoenixElixir.PubSub
end
